...
import front_logo from '../assets/front_logo.png'
    ...
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme ="forest">
      <div className='border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden'>
        ...
        <ShipWheelIcon className='size-9 text-primary'/>
            <span className='text-3xl font-bold font-mono bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary tracking-wider'>ChatWith
            ...
            <form onSubmit={handleLogin}>
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm opacity-70'>Sign in to your account tp continue your language journey</p>
                </div>
